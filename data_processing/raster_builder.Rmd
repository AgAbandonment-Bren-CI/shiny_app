...
```{r}
# reclassify and save rasters

# matrix that turns values between 1-7 to just 1
reclass_m <- matrix(c(1,7,1), ncol = 3, byrow = TRUE)

# now reclassify all 
ssp1_brazil_rcl <- classify(ssp1_brazil, reclass_m)
ssp2_brazil_rcl <- classify(ssp2_brazil, reclass_m)
ssp3_brazil_rcl <- classify(ssp3_brazil, reclass_m)
ssp4_brazil_rcl <- classify(ssp4_brazil, reclass_m)
ssp5_brazil_rcl <- classify(ssp5_brazil, reclass_m)
