...
ssp1_50k <- agg_func(diff_ssp1_2050)
ssp2_50k <- agg_func(diff_ssp2_2050)
ssp3_50k <- agg_func(diff_ssp3_2050)
ssp4_50k <- agg_func(diff_ssp4_2050)
ssp5_50k <- agg_func(diff_ssp5_2050)
```
